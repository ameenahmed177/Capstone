...
summary_df.to_csv('regression_results_with_vif_excluding_high_vif.csv')

print("Regression results have been saved to 'regression_results_with_vif_excluding_fgm_and_high_vif.csv'")